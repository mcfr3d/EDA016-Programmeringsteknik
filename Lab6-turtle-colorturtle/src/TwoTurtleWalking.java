...
public class TwoTurtleWalking {
	public static void main(String[] args) {
		SimpleWindow w = new SimpleWindow(600, 600, "turtlewalker");
		Random rand = new Random();
		Turtle turt1 = new Turtle(w, 250, 250);
		Turtle turt2 = new Turtle(w, 350, 350);
 ...
 * 
 * turt1.penDown(); int stepLength2 = rand.nextInt(10) + 1; int turnDeegre2 =
 * 
 * rand.nextInt(360 + 1) - 180; turt1.forward(stepLength2);
 * 
 ...
 * 
 * turt2.penDown(); int stepLength2 = rand.nextInt(10) + 1; int turnDeegre2 =
 * 
 * rand.nextInt(360 + 1) - 180; turt2.forward(stepLength2);
 * 
 * turt2.left(turnDeegre2); }
 * 
 */